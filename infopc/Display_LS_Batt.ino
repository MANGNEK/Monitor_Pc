...
void Display_LS_Batt () {
  ...
  if (BL.getBatteryVolts() <= 3.2 ) {
    ...
    if (stringComplete) {
      ...
      tft.drawRoundRect  (0,  0  , 400, 120, 8,    ILI9341_BLUE);

      tft.drawRoundRect  (0, 124,  400, 116, 8,    ILI9341_GREEN);
...
#define ILI9341_updateBox  ILI9341_BLACK // Default for normal running
      ...
      /* CPU TEMP,*/
      // if (cpuString1.length() == 3) cpuString1 = ""  + cpuString1;
      // if (cpuString1.length() == 2) cpuString1 = " "  + cpuString1;
      if (cpuString1.length() == 1) cpuString1 = " "  + cpuString1;
      

      /* CPU LOAD,*/
      if (cpuString2.length() == 1) cpuString2 = " "  + cpuString2;
      ...
      //tft.print("890"); // Test Spacing

      //tft.println("1000"); // Test Spacing
...
tft.print((char)247);
      ...
      /* CPU LOAD, ALL CORES */
      tft.setTextSize(3);
      tft.setCursor(190 , 25);// (Left/Right, UP/Down)
      tft.print("   ");  // CPU Load 
      tft.setCursor(190 , 25);// (Left/Right, UP/Down)
      ...
      */
      ...
      //Char erase and spacing adjust, MaDerer
      /* GPU TEMP,*/
      if (gpuString1.length() == 1) gpuString1 = " "  + gpuString1;
      // if (gpuString1.length() == 2) gpuString1 = " "  + gpuString1;
      // if (gpuString1.length() == 3) gpuString1 = ""  + gpuString1;
      
      /* GPU LOAD,*/
      // if (gpuString2.length() == 3) gpuString2 = ""  + gpuString2;
      // if (gpuString2.length() == 2) gpuString2 = "" + gpuString2;
      if (gpuString2.length() == 1) gpuString2 = " " + gpuString2;
      ...
      /* GPU LOAD */
      tft.setTextSize(3);
      tft.setCursor(190 , 144);// (Left/Right, UP/Down)
      tft.print("   ");  // CPU Load 
      tft.setCursor(190 , 144); // (Left/Right, UP/Down)
      ...
      */
      ...
      tft.setTextSize(3);
      tft.setCursor(270, 144);   // (Left/Right, UP/Down)
      //tft.print("Fan Load :");
      ...
      tft.setTextSize(1);
      tft.setCursor(272, 24);// (Left/Right, UP/Down)
      tft.print ("Batt:");
...
#ifdef enable_Thresholdtriggers_PCB //Landscape 
