...
void CPU_loadGauge(int cpuUsage ) {
  ...
  if (CPUloadfactor >= 0 ) {
    pixels.setPixelColor(8, 229, 193, 0); // 1st Pixel
  }
  if (CPUloadfactor >= 12.5 ) {
    pixels.setPixelColor(7, 230, 165, 1);
  }
  if (CPUloadfactor >= (12.5 * 2) ) {
    pixels.setPixelColor(6, 232, 137, 2);
  }
  if (CPUloadfactor >= (12.5 * 3) ) {
    pixels.setPixelColor(5, 233, 110, 3);
  }
  if (CPUloadfactor >= (12.5 * 4) ) {
    pixels.setPixelColor(4, 235, 82, 4);
  }
  if (CPUloadfactor >= (12.5 * 5) ) {
    pixels.setPixelColor(3, 236, 55, 5);
  }
  if (CPUloadfactor >= (12.5 * 6) ) {
    pixels.setPixelColor(2, 238, 27, 6);
  }
  if (CPUloadfactor >= (12.5 * 7) ) {
    pixels.setPixelColor(1, 240, 0, 7);
  }
