...
#define ILI9341_updateBox  ILI9341_BLACK // Default for normal running
      ...
      /* GPU TEMPERATURE */
      tft.setTextSize(3);
      tft.setCursor(45 - X_Offset, 144 + Y_Offset); // (Left/Right, UP/Down)
      ...
      tft.setTextSize(1);
      tft.setCursor(248, 24);// (Left/Right, UP/Down)
      tft.print ("Batt:");

      tft.setCursor(248, 33);// (Left/Right, UP/Down)
      ...
      //--------------------------
      tft.setCursor(248, 42);// (Left/Right, UP/Down)
